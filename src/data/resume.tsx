  ...
  projects: [
    {
      ...
      active: true,
      description: "A decentralized perpetuals exchange on Arweave/AO that aims to create synthetic assets that mimic the price of another asset without ever holding the actual asset.",
      technologies: [
        "Lua",
        "Arweave",
        "React.js",
